...
#. File raw data can either be :ref:`created directly<>` or :ref:`imported via a File Importer<File Importers>`
#. Blocks on Files can either be :ref:`created directly<>` or :ref:`created from raw data by a Blockifier<Blockifiers>`
