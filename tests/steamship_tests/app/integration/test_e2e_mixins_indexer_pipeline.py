...
def test_indexer_pipeline_mixin(client: Steamship):
    ...
    with deploy_package(client, demo_package_path) as (_, _, instance):
        ...
        # NOTE NOTE NOTE - This portion of the test will be added.. but commented out
        # Since replying on YouTube parsing in our unit tests is just asking for random failures.
